...
public abstract class SOAPFaultBuilder {
    ...
    static {
        ...
        try {
            // ignore searching jaxb context, we need a RI one. Create it from specified factory
            //JAXB_CONTEXT = JAXBContext.newInstance(SOAP11Fault.class, SOAP12Fault.class);
            Class[] classes = {SOAP11Fault.class, SOAP12Fault.class};
            JAXB_CONTEXT = com.sun.xml.bind.v2.ContextFactory.createContext(classes, null);
